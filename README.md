...
```bash
# Build the local image (choose a remote registry only after maintainer approval)
...
> [!TIP]
> **Local Docker image:** `local/my-api:custom-rc25` (build it from this repository; use a remote registry only after approval)
