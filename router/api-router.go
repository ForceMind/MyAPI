...
import (
	...
	_ "github.com/ForceMind/MyAPI/oauth"
...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/request-summary", middleware.AdminAuth(), controller.GetRecordedRequestSummary)
		logRoute.GET("/self/stat", middleware.UserAuth(), controller.GetLogsSelfStat)
		logRoute.GET("/self/request-summary", middleware.UserAuth(), controller.GetRecordedRequestSelfSummary)
