...
var auditContentTemplates = map[string]string{
	...
	"option.typed_bulk_update": "Updated managed settings in bulk: ${keys}",
	"option.remediate_dry_run": "Previewed option remediation: ${items} items, ${repairs} repairs",
	"option.remediate_apply":   "Applied option remediation: ${applied} applied, ${skipped} skipped, ${failed} failed, ${already_applied} already applied",
