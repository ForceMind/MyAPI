...
export const STATIC_I18N_KEYS = [
  ...
  // Quota writer mode (dynamic audit / finding labels)
  'Quota Writer Mode',
  ...
  'The writer is already in authoritative mode.',
  ...
  'The batch update queue is not empty.',
  'Balance drain generations are still pending.',
  'A balance drain is still in flight.',
  'The balance drain state could not be audited.',
  'Maintenance backfills are not complete.',
  'Projection obligations are still pending.',
  'The Redis epoch is not consistent with the persisted epoch.',
  'Billing sessions are still in flight.',
  'The persisted writer epoch state is unavailable.',
  'The new epoch could not be published to Redis.',
  'The post-transition audit failed to run.',
  'The committed epoch could not be read back.',
  ...
  'Primary change',
  'Secondary change',
  'Codex usage history unavailable',
  'Codex usage history is unavailable',
  'Unable to load Codex usage history',
  'No Codex usage history yet',
  ...
  'Import local Codex',
  'Importing...',
  'Local Codex account detected',
  'Local Codex account is ready to import.',
  'Local Codex credential imported',
  'Local Codex import is unavailable',
  'Local Codex import is unavailable in LAN Lite.',
  ...
  'Unable to check local Codex status',
  'Unable to determine the local Codex login status.',
  'No Codex login file was found for the MyAPI process user.',
  'MyAPI cannot read the local Codex login file.',
  'The local Codex login file is invalid or incomplete.',
  'MyAPI is running in a container and cannot access the host Codex login.',
  'Local Codex import is disabled for this MyAPI environment.',
  ...
  'Fill channel credential',
  'Failed to import local Codex credential',
  'Channel details are required before import.',
  'Complete the required channel fields before import.',
  'Verify to import local Codex credential',
