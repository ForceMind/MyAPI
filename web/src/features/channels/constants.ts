...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  50: 'Format: AccessKey|SecretKey (or just ApiKey for compatible upstream relays)',
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  8: 'If connecting to compatible upstream relay projects, use OpenAI type unless you know what you are doing',
