...
- 静态官网已补齐移动菜单关闭、outside-click、Escape、焦点回归与 Tab 约束、主题偏好持久化等基础交互，并加入资源/结构自动校验与 390px/320px Chromium 移动 smoke workflow；GitHub Actions 已有成功的真实 Chromium smoke 运行（workflow run `33328422939`），真实设备/移动视觉审查与独立发布 workflow 仍待完成。
