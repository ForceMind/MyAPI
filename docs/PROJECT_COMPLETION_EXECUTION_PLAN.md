...
| B2-1 密钥/模型/迁移 | 本地修复/复验及独立复审通过，待实库 CI/同步 | 2026-09-06 已补 GORM 动态表表达式与链式句柄标记泄漏保护、v1 dispatch savepoint panic 回滚；受限环境 common/model 定向测试及 model vet 通过，独立复审无 P1/P2/P3；MySQL/PG/ClickHouse CI 与同步待补 |
