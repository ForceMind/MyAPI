...
distribution. MyAPI is the distribution name for this customized build based on
New API `v1.0.0-rc.25`; the original New API, QuantumNous, AGPL, NOTICE,
About-page attribution, and project links remain intact.
